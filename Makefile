...
srcObjects = $(addprefix $(buildDir_ConsoleParser)/, $(sources:.cpp=.o))
...
$(srcObjects): $(buildDir_ConsoleParser)/%.o: $(srcDir)/%.cpp
	@echo [CXX] -c $< -o $@
	@$(CXX) $(CXXFLAGS) -c $< -o $@

prepare:
	@mkdir -p $(buildDir_ConsoleParser)
